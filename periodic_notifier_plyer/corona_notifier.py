# Source - https://towardsdatascience.com/create-desktop-notifier-application-using-python-fb3b7b2c3cf3 
...
if covidData is not None:
    ...
    while True:
        ...
        # time.sleep(60 * 60 * 4)
        # notification repeats every 2 minutes
        time.sleep(120)
